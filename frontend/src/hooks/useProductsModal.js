...
export const useProductsModal = () => {
  ...
  const isCampaignPickerOpen = useModalStore((state) =>
    state.isOpen("campaignPicker"),
  );
  const isPriceAdjustOpen = useModalStore((state) =>
    state.isOpen("priceAdjust"),
  );
  const isDeleteConfirmOpen = useModalStore((state) =>
    state.isOpen("deleteConfirm"),
  );
  const isBulkDeleteConfirmOpen = useModalStore((state) =>
    state.isOpen("bulkDeleteConfirm"),
  );
