                  ...
                  {cart.map((item) => (
                    ...
                    >
                      <Link
                        ...
                        onClick={onClose}
                        className="shrink-0 relative overflow-hidden rounded-lg bg-gray-100 dark:bg-zinc-800 w-20 h-24"
                      >
                        <img
                          src={item.image}
                          alt={item.name}
                      ...
                      <div className="flex flex-col flex-1 min-w-0">
                        <Link
                          to={buildProductPath(item) || "#"}
                          onClick={onClose}
                          className="text-sm font-semibold text-gray-900 dark:text-white truncate hover:text-luxury-gold transition-colors"
                        >
                          {item.name}
                        </Link>
              ...
              <div className="p-5 bg-gray-50 dark:bg-white/5 border-t border-gray-100 dark:border-white/10">
                ...
                <div className="mt-3 text-center">
                  <button
                    ...
                    className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors underline-offset-4 hover:underline"
                  >
