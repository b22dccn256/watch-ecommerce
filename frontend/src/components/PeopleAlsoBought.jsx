...
const PeopleAlsoBought = () => {
      ...
      try {
        ...
        toast.error(
          error.response?.data?.message ||
            "Lỗi khi tải danh sách sản phẩm gợi ý",
        );
      } finally {
        setIsLoading(false);
      }
  ...
  return (
    <div className="mt-10">
      <h3 className="hero-title text-lg md:text-xl font-semibold text-primary">
        ...
        {recommendations.map((product) => (
          ...
          >
            ...
            <div className="p-3 md:p-4 space-y-1.5">
              <p className="text-[10px] uppercase tracking-[0.24em] text-gray-400 dark:text-gray-500">
                Đồng hồ luxury
              </p>
