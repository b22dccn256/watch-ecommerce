		...
		<div className="space-y-8">
			...
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
				<div>
					...
					<p className="text-luxury-text-muted text-sm mt-1">Sử dụng trí tuệ nhân tạo để tối ưu hóa vận hành cửa hàng.</p>
				</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<motion.div 
					whileHover={{ y: -5 }}
					className="bg-luxury-dark border border-luxury-border rounded-3xl p-8 space-y-6 relative overflow-hidden group"
				>
					...
					<div className="space-y-2">
						<h3 className="text-xl font-bold text-white uppercase tracking-wider">Xác Nhận Đơn Thông Minh</h3>
					...
					<ul className="space-y-3">
						<li className="flex items-center gap-3 text-xs text-luxury-text-muted">
					...
					<button 
						...
						className="w-full py-4 bg-white/5 border border-luxury-border hover:bg-luxury-gold hover:text-luxury-dark rounded-xl font-bold transition duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
					>
				...
				>
					...
					<div className="space-y-2">
						<h3 className="text-xl font-bold text-white uppercase tracking-wider">Dọn Dẹp Tài Khoản Rác</h3>
						<p className="text-sm text-luxury-text-muted leading-relaxed">
					...
					<button 
						...
						className="w-full py-4 bg-white/5 border border-luxury-border hover:bg-red-500 hover:text-white rounded-xl font-bold transition duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
					>
			...
			{/* AI Logs / Status */}
			<div className="bg-luxury-darker border border-luxury-border rounded-3xl p-6">
				...
				<div className="space-y-3 font-mono text-[11px]">
					{logs.map((log, i) => (
						<div key={i} className="flex gap-4 border-l border-luxury-border pl-4">
							<span className="text-luxury-text-muted whitespace-nowrap">[{log.time}]</span>
							<span className={
