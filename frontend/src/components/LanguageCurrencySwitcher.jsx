          ...
          <div className="absolute right-0 mt-1 w-24 bg-white dark:bg-luxury-darker border border-gray-200 dark:border-luxury-border rounded-lg shadow-lg z-50 overflow-hidden">
            <div className="py-1">
              ...
              >
                ...
                <span className="text-gray-700 dark:text-luxury-text-light">EN</span>
              </button>
              <button
              ...
              >
                <img src={flags.vi} alt="VN" className="w-5 h-5 rounded-full object-cover" />
                <span className="text-gray-700 dark:text-luxury-text-light">VN</span>
              </button>
            </div>
          </div>
        )}
