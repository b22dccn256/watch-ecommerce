              ...
              <div className="flex flex-col items-center gap-3 bg-surface-soft px-2 group">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center font-bold text-sm md:text-base transition-colors duration-300 shadow-sm
									${
                    isCompleted
                      ? "bg-[color:var(--color-gold)] text-black border-2 border-[color:var(--color-gold)]"
                      : isActive
                        ? "bg-surface text-[color:var(--color-gold)] border-2 border-[color:var(--color-gold)]"
                ...
                <span
                  className={`text-xs md:text-sm font-bold uppercase tracking-[0.12em] text-center
