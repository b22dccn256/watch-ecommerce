          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[color:var(--color-gold)] text-sm font-semibold">
                  {campaignName || "Sự Kiện Đặc Quyền"}
                </span>
              </div>
            ...
            <div className="flex flex-wrap gap-2 text-center">
              {Object.entries(timeLeft).map(([label, value]) => {
                ...
                return (
                  <div
                    key={label}
                    className="min-w-[64px] sm:min-w-[72px] bg-white/70 dark:bg-zinc-900/80 backdrop-blur-md px-3 py-2 rounded-xl border border-black/5 dark:border-white/8 shadow-sm"
                  >
