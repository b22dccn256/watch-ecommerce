        ...
        >
          ...
          <div className="relative h-48 md:h-full min-h-[180px] bg-black">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white">
              ...
              <p className="font-serif text-lg leading-tight mt-1.5 text-white/95">
              ...
              {!success ? (
                ...
                >
                  ...
                  <p className="text-[10px] text-muted text-center italic">
                    * Chúng tôi cam kết bảo mật thông tin và chỉ gửi đặc quyền
                    cao cấp nhất.
                  </p>
                </motion.div>
              ) : (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-serif text-lg font-bold text-emerald-400 uppercase">
                      Chào mừng thành viên VIP!
                    </h4>
                    <p className="text-xs text-secondary mt-2 max-w-xs leading-relaxed">
                      Ưu đãi đặc quyền của bạn đã được kích hoạt thành công. Vui
                      lòng kiểm tra hộp thư email chào mừng của bạn!
                    </p>
                  </div>
                </motion.div>
              )}
