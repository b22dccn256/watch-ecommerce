    ...
    <div className="p-5 flex flex-col gap-3 flex-1 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,245,240,0.98))] dark:bg-zinc-900">
      ...
      <div className="flex gap-1 mt-1">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="w-4 h-4 rounded-full bg-gray-200 dark:bg-zinc-800 skeleton-shimmer skeleton-shimmer-premium"
          />
        ))}
      </div>
      {/* Price */}
...
export const SkeletonTableRow = () => (
  <tr>
    ...
    <td className="px-6 py-4">
      <div className="h-4 w-20 rounded-full bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium" />
    </td>
    <td className="px-6 py-4">
      <div className="h-4 w-24 rounded-full bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium" />
    </td>
    <td className="px-6 py-4">
      <div className="h-5 w-20 rounded-full bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium" />
    </td>
    <td className="px-6 py-4">
      <div className="h-7 w-7 rounded-full bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium" />
    </td>
    <td className="px-6 py-4">
      <div className="h-7 w-7 rounded-full bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium" />
    </td>
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl border border-gray-200/80 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 space-y-4 shadow-[0_16px_50px_-30px_rgba(0,0,0,0.35)]">
        {Array.from({ length: rows }).map((_, i) => (
          <div
            key={i}
            className="h-16 rounded-xl bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium"
          />
        ))}
      </div>
    </div>
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="flex gap-3">
            {Array.from({ length: 4 }).map((_, i) => (
              <div
                key={i}
                className="h-20 w-20 rounded-2xl bg-gray-200 dark:bg-zinc-700 skeleton-shimmer skeleton-shimmer-premium"
              />
            ))}
          </div>
        </div>
