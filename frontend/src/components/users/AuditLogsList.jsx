    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
        {logsLoading ? (
          ...
          <p className="text-center text-[10px] text-gray-400 py-10 uppercase tracking-widest">
            Chưa có nhật ký
          </p>
        ) : (
          auditLogs.map((log) => {
              ...
              >
                <div className="flex flex-col gap-2.5">
                  <div className="flex items-center">
                    <span
                      className={`text-[9px] font-bold px-2 py-1 bg-gray-100 dark:bg-white/5 rounded uppercase tracking-wider ${isDanger ? "text-red-500" : isSuccess ? "text-emerald-600 dark:text-emerald-400" : "text-blue-600 dark:text-blue-400"}`}
                    >
                      {log.action}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm font-medium text-gray-600 dark:text-luxury-text-muted">
