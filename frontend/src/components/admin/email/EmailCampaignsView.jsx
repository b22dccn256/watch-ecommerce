...
const EmailCampaignsView = ({
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case "sent":
        return (
          <span className="px-2.5 py-1 text-[10px] font-bold tracking-widest text-green-600 bg-green-100 rounded-full uppercase">
            Đã gửi
          </span>
        );
      case "sending":
        return (
          <span className="px-2.5 py-1 text-[10px] font-bold tracking-widest text-blue-600 bg-blue-100 rounded-full uppercase flex items-center gap-1">
            <RefreshCw className="w-3 h-3 animate-spin" /> Đang gửi
          </span>
        );
      case "scheduled":
        return (
          <span className="px-2.5 py-1 text-[10px] font-bold tracking-widest text-amber-600 bg-amber-100 rounded-full uppercase">
            Lên lịch
          </span>
        );
      case "failed":
        return (
          <span className="px-2.5 py-1 text-[10px] font-bold tracking-widest text-red-600 bg-red-100 rounded-full uppercase">
            Thất bại
          </span>
        );
      default:
        return (
          <span className="px-2.5 py-1 text-[10px] font-bold tracking-widest text-gray-600 bg-gray-100 rounded-full uppercase">
            Bản nháp
          </span>
        );
    }
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Quản lý và theo dõi hiệu quả các chiến dịch email marketing.
          </p>
        </div>
        <button
                ...
                campaigns.map((camp) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      <div className="text-[10px] uppercase mt-1 tracking-widest text-[#1e40af] font-bold">
                        Đối tượng:{" "}
                ...
                <div>
                  ...
                  >
                    <option value="newsletter">
                      Người đăng ký nhận tin (Newsletter)
                    </option>
