        ...
        >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setCatForm({ ...catForm, parentCategory: e.target.value })}
              className="w-full border rounded-lg px-4 py-2 text-sm"
            >
          ...
          <div>
            ...
            <div className="flex gap-4 items-center">
              <div className="w-12 h-12 border rounded bg-gray-100 flex items-center justify-center">
                {catForm.image ? <img src={catForm.image} alt="" className="w-full object-cover" /> : <Grid className="w-5 h-5 text-gray-400" />}
              </div>
              <input type="file" accept="image/*" onChange={(e) => processImage(e.target.files[0], setCatForm)} className="w-full border p-1 rounded text-xs" />
            </div>
          </div>
