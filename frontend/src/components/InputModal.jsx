      ...
      >
        ...
        >
          <div className="p-6">
            ...
            <div className="mt-4">
              <label className="text-xs text-gray-500 block mb-2 font-bold">
                {label}
              </label>
              <input
                type="text"
          ...
          <div className="flex items-center gap-3 px-6 py-4 bg-zinc-50 dark:bg-zinc-800/50 border-t border-zinc-100 dark:border-zinc-800">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2.5 rounded-xl text-sm font-semibold text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition"
            >
              Hủy
            </button>
            <button
              ...
              disabled={loading}
              className="flex-1 px-4 py-2.5 rounded-xl text-sm font-bold bg-luxury-gold text-luxury-dark hover:bg-yellow-500 transition"
            >
              {confirmLabel}
            </button>
          </div>
