    ...
    <section className="pt-12 pb-12 border-t border-black/8 dark:border-white/8">
      ...
      >
        ...
        <p className="text-base leading-relaxed text-secondary max-w-2xl">
          Khám phá những chiếc đồng hồ cao cấp khác trong bộ sưu tập của chúng
          tôi. Mỗi mẫu được curation để đáp ứng nhu cầu của những nhà sưu tập
          đồng hồ được yêu cầu nhất, từ những mẫu kinh điển vĩnh hằng đến những
          tác phẩm contemporary contemporary độc quyền.
        </p>
      </motion.div>
