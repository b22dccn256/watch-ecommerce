...
const WarrantyPage = () => {
  const steps = [
    ...
    {
      title: "Gửi hàng",
      desc: "Đội vận chuyển đến lấy hàng tận nơi miễn phí.",
      icon: RotateCcw,
    },
    {
      title: "Kiểm tra",
      desc: "Kỹ thuật viên kiểm tra bằng máy đo chuyên dụng.",
      icon: PenTool,
    },
    {
      title: "Hoàn tất",
      desc: "Sửa chữa hoặc đổi mới sản phẩm cho khách.",
      icon: CheckCircle,
    },
  ];
      ...
      <section className="space-y-10">
        <div className="bg-luxury-gold/10 p-7 rounded-[2rem] border border-luxury-gold/20 shadow-sm max-w-3xl">
          ...
          <p className="text-gray-600 dark:text-luxury-text-muted leading-relaxed">
            Mọi chiếc đồng hồ được bán ra tại Luxury Watch Store đều đi kèm gói{" "}
            <span className="font-bold">Bảo hành Vàng 5 năm</span>. Gói bảo hành
            này bao gồm cả các lỗi do người dùng (như rơi vỡ, vào nước) trong
        ...
        <div className="space-y-6">
          <h3 className="hero-title text-xl font-semibold text-gray-900 dark:text-white">
            Chính sách Đổi trả
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-luxury-border rounded-2xl bg-white/60 dark:bg-white/5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Nếu lỗi phát sinh từ nhà sản xuất, khách hàng được đổi sản phẩm
                mới cùng model.
              </p>
            </div>
            <div className="p-4 border border-luxury-border rounded-2xl bg-white/60 dark:bg-white/5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Trong vòng 7 ngày đầu nếu quý khách không hài lòng về trải
                nghiệm (sản phẩm phải còn seal).
              </p>
            </div>
          </div>
        </div>
