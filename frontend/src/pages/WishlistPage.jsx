  ...
  return (
    <div className="min-h-screen bg-white dark:bg-luxury-dark text-gray-900 dark:text-white pt-28 pb-16 transition-colors duration-300">
      <div className="max-w-screen-2xl mx-auto px-6 h-full">
        ...
        >
          <div>
            <p className="hero-kicker text-[11px] text-[color:var(--color-gold)] mb-3">
              Client Selection
            </p>
            <h1 className="hero-title text-3xl md:text-4xl font-bold mb-4 text-primary">
              Danh sách yêu thích
            </h1>
...
const EmptyWishlist = () => (
  ...
  >
    ...
    <h2 className="hero-title text-2xl font-bold mb-4 text-primary">
      Chưa có sản phẩm yêu thích
    </h2>
    <p className="text-secondary mb-10 max-w-md mx-auto">
      Bạn chưa thêm bất kỳ sản phẩm nào vào danh sách mong muốn. Hãy khám phá bộ
      sưu tập của chúng tôi để tìm thấy chiếc đồng hồ hoàn mỹ dành riêng cho
      bạn.
    </p>
    <Link
      to="/catalog"
