		...
		>
			<div className="space-y-8 text-gray-600 dark:text-luxury-text-muted">
				...
				<section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">1. Mục đích thu thập thông tin</h3>
				...
				<section className="space-y-4 md:ml-8">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">2. Phạm vi sử dụng thông tin</h3>
				...
				<section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">3. Cam kết bảo mật</h3>
				...
				<section className="space-y-4 md:ml-8">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">4. Quyền lợi của khách hàng</h3>
