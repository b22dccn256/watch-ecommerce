    ...
    >
      <div className="space-y-8 text-gray-600 dark:text-luxury-text-muted">
        ...
        <section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
          ...
          <p>
            Chúng tôi thu thập thông tin cá nhân của bạn để hỗ trợ quá trình đặt
            hàng, giao hàng và chăm sóc khách hàng tốt hơn. Các thông tin bao
        ...
        <section className="space-y-4 md:ml-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Gửi thông báo về các chương trình khuyến mãi (nếu bạn đăng ký).
            </li>
            <li>
              Nâng cao chất lượng dịch vụ và cá nhân hóa trải nghiệm người dùng.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
          ...
          <p>
            Luxury Watch Store cam kết không bán, chia sẻ hay trao đổi thông tin
            cá nhân của khách hàng cho bất kỳ bên thứ ba nào khi chưa có sự đồng
            ý của quý khách, ngoại trừ các đơn vị vận chuyển đối tác.
          </p>
          <p>
            Chúng tôi sử dụng các công nghệ mã hóa SSL tiêu chuẩn để bảo vệ dữ
            liệu truyền tải trên hệ thống.
          </p>
        </section>
        ...
        <section className="space-y-4 md:ml-8">
          ...
          <p>
            Quý khách có quyền yêu cầu truy cập, chỉnh sửa hoặc xóa thông tin cá
            nhân của mình bất kỳ lúc nào bằng cách đăng nhập vào tài khoản hoặc
