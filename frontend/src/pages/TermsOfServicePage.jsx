	...
	return (
		...
		>
			<div className="space-y-8 text-gray-600 dark:text-luxury-text-muted">
				<p className="max-w-3xl">Chào mừng bạn đến với Luxury Watch Store. Khi bạn sử dụng website của chúng tôi, bạn đồng ý tuân thủ các điều khoản sau đây.</p>
				
				<section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">1. Quyền sở hữu trí tuệ</h3>
				...
				<section className="space-y-4 md:ml-8">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">2. Trách nhiệm người dùng</h3>
				...
				<section className="space-y-4 border-l border-black/10 dark:border-white/10 pl-5 md:pl-7">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">3. Chính sách giá cả</h3>
				...
				<section className="space-y-4 md:ml-8">
					<h3 className="hero-title text-xl font-bold text-black dark:text-white">4. Giải quyết tranh chấp</h3>
