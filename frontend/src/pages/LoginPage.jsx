      ...
      <div className="flex flex-1 items-center justify-center bg-white dark:bg-[#161310] px-6 py-14 sm:px-12 w-full lg:w-1/2">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8 lg:hidden">
            ...
            <span className="inline-block px-3 py-1 rounded-full bg-[color:var(--color-gold)]/10 border border-[color:var(--color-gold)]/20 text-[10px] font-semibold text-[color:var(--color-gold)] uppercase">
              SMEMBER
            </span>
          </div>
            ...
            {step === "login" && (
              ...
              >
                ...
                <div className="mb-7 space-y-1">
                  <h1 className="text-[1.75rem] font-bold text-primary leading-tight">
                    Đăng nhập SMEMBER
                  </h1>
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  <div className="space-y-1.5">
                    <label
                      htmlFor="email"
                      className="block text-[10px] font-semibold uppercase tracking-[0.15em] text-secondary"
                    >
                      Email
                    </label>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24">
                      <path
                        fill="#EA4335"
                        d="M12.545,10.239v3.821h5.445c-0.231,1.139-1.317,3.33-5.445,3.33c-3.284,0-5.962-2.73-5.962-6.101s2.678-6.101,5.962-6.101c1.86,0,3.109,0.796,3.818,1.472l2.997-2.909c-1.782-1.636-4.085-2.617-6.816-2.617c-5.467,0-9.897,4.48-9.897,10.038s4.43,10.038,9.897,10.038c5.719,0,9.507-4.02,9.507-9.673c0-0.742-0.088-1.393-0.211-1.999H12.545z"
                      />
                    </svg>
                    Tiếp tục với Google
                  </a>
                ...
                <p className="mt-8 text-center text-sm text-secondary">
                  ...
                  <Link
                    to="/signup"
                    className="font-semibold text-[color:var(--color-gold)] hover:underline"
                  >
                    Đăng ký ngay
                  </Link>
                </p>
              ...
              >
                ...
                <form onSubmit={handleVerifySubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted">
                    <span>
                      Hết hạn:{" "}
                      <strong className="text-primary">{fmt(otpExpiry)}</strong>
                    </span>
                    <button
                      type="button"
