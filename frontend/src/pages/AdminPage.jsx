          ...
          <>
            ...
            >
              <div className="h-[72px] flex items-center justify-between border-b border-gray-100 dark:border-luxury-border px-3">
                <a href="/" className={`admin-sidebar-link group relative w-full transition-all duration-300 ease-in-out text-gray-900 dark:text-white hover:text-luxury-gold hover:bg-gray-50 dark:hover:bg-luxury-border/50 text-left`}>
                  <Home className="w-5 h-5 flex-shrink-0" />
                  <span className="truncate">Trang chủ</span>
                </a>
                <button onClick={() => setSidebarOpen(false)} className="p-2 ml-2 rounded-md text-gray-400 hover:text-gray-900 dark:hover:text-white transition flex-shrink-0">
                  <X className="w-5 h-5" />
                </button>
              </div>
              <SidebarNav />
