      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 xl:gap-16">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <p className="hero-kicker text-xs font-semibold text-luxury-gold">
              Concierge
            </p>
            <h2 className="hero-title text-2xl font-bold text-gray-900 dark:text-white">
              Gửi lời nhắn cho chúng tôi
            </h2>
            <p className="text-luxury-text-muted text-sm leading-relaxed">
              Chúng tôi luôn sẵn lòng lắng nghe và giải đáp mọi thắc mắc của quý
              khách. Phản hồi sẽ được gửi qua email của bạn trong vòng 24 giờ
              làm việc.
            </p>
          </div>
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-lg font-bold">
                  123 Luxury Tower, Q1, TP. HCM
                </p>
                <p className="text-xs text-gray-400 mt-1">
                  Chi nhánh HN: 456 Watch Plaza, Cầu Giấy
                </p>
              </div>
            </div>
          </div>
