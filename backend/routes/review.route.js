...
import { validateBody, reviewSchemas } from "../middleware/validation.middleware.js";

const router = express.Router();

router.get("/product/:productId", getProductReviews);
router.post("/product/:productId", protectRoute, validateBody(reviewSchemas.create), createReview);
