    ...
    try {
      await EmailTemplate.findOneAndUpdate(
        { name: "Xác nhận đơn hàng" },
        {
          ...
          description:
            "Mẫu email xác nhận đơn hàng sau khi khách hàng đặt hàng thành công.",
      ...
      await EmailTemplate.findOneAndUpdate(
        { name: "Chào mừng thành viên" },
        {
          ...
          description:
            "Mẫu email gửi khi khách hàng đăng ký nhận tin hoặc tạo tài khoản.",
          category: "marketing",
          isActive: true,
        },
        { upsert: true, new: true, returnDocument: "after" },
      ...
      await EmailTemplate.findOneAndUpdate(
        { name: "Nhắc nhở giỏ hàng bị bỏ quên" },
        {
          ...
          description:
            "Mẫu email tự động gửi khi khách hàng thêm sản phẩm vào giỏ nhưng chưa thanh toán.",
          category: "automation",
          isActive: true,
        },
        { upsert: true, new: true, returnDocument: "after" },
