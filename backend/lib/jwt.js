...
export const getAccessTokenSecrets = () =>
	collectSecrets(process.env.ACCESS_TOKEN_SECRET, process.env.ACCESS_TOKEN_SECRET_PREVIOUS);

export const getRefreshTokenSecrets = () =>
	collectSecrets(process.env.REFRESH_TOKEN_SECRET, process.env.REFRESH_TOKEN_SECRET_PREVIOUS);
